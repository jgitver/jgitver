...
public class Scenario5AutoIncTest extends ScenarioTest {

    public Scenario5AutoIncTest() {
        super(
    ...
    public void version_of_branch_int() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.0.1-1-int"));
    }
    ...
    public void version_of_branch_dev() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.0.1-1-dev"));
    }
}
