...
public class Scenario8WithLongFormatTest extends ScenarioTest {
    ...
    public void version_of_A_commit() {
        ...
        assertThat(versionCalculator.getVersion(), is("0.0.0-0" + "-g" + firstCommit.name().substring(0,8)));
    }
    ...
    public void version_of_B_commit() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.0.0-0" + "-g" + bCommit.name().substring(0,8)));
    }
    ...
    public void version_of_C_commit() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.0.0-1" + "-g" + cCommit.name().substring(0,8)));
    }
    ...
    public void version_of_D_commit() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.1.0-0" + "-g" + dCommit.name().substring(0,8)));
    }
    ...
    public void version_of_E_commit() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.1.0-1" + "-g" + eCommit.name().substring(0,8)));
    }
    ...
    public void version_of_F_commit() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.0.0-2" + "-g" + fCommit.name().substring(0,8)));
    }

    @Test
    public void version_of_annotated_tags() {
        unchecked(() -> git.checkout().setName("1.0.0").call());
        assertThat(versionCalculator.getVersion(), is("1.0.0-0" + "-g" + scenario.getCommits().get("B").name().substring(0,8)));
    }
    
    @Test
    public void version_of_light_tag_1_1_0() {
        unchecked(() -> git.checkout().setName("1.1.0").call());
        assertThat(versionCalculator.getVersion(), is("1.1.0-0" + "-g" + scenario.getCommits().get("D").name().substring(0,8)));
    }
    ...
    public void version_of_master() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.1.0-1" + "-g" + scenario.getCommits().get("E").name().substring(0,8)));
    }
    ...
    public void version_of_branch_issue_10() {
        ...
        assertThat(versionCalculator.getVersion(), is("1.0.0-2"+ "-g" + scenario.getCommits().get("F").name().substring(0,8) + "-issue_10"));
    }
}
