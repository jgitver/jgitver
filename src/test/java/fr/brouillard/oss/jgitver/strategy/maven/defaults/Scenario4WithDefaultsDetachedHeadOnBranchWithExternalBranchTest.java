...
public class Scenario4WithDefaultsDetachedHeadOnBranchWithExternalBranchTest extends ScenarioTest {

    public Scenario4WithDefaultsDetachedHeadOnBranchWithExternalBranchTest() {
        super(
