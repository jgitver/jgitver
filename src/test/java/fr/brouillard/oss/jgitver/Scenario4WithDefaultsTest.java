...
public class Scenario4WithDefaultsTest {
    ...
    public void version_of_F_commit() {
        ...
        // checkout the F commit in scenario
        // branch is lost, as it is a detached head
    ...
    public void version_of_G_commit() {
        ObjectId cCommit = scenario.getCommits().get("G");
    ...
    @Test
    public void version_of_branch() {
        // checkout the branch
        unchecked(() -> git.checkout().setName("issue-10").call());
        assertThat(versionCalculator.getVersion(), is("1.0.0-3-issue_10"));
    }
}
